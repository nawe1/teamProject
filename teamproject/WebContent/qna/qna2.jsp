...
<body>
    <div id="header">
        ...
        <div id="test">
            <div class="notiTitle">
                <p class="tt">&nbsp;<img src="${hpath }/imgs/notice/qna.png">&nbsp;&nbsp;자유게시판</p>
            </div>
            <br><br>
            <div class="noticebox" id="">
                <p>
                    -  글은 포항시 시민 또는 포항을 방문하시는 분들을 위해 다양한 정보를 공지하는 공간입니다.<br>
                    -  글은 별도의 답변을 드리지 않습니다. 만약 질문이 있으시다면 QnA 게시판를 이용하시고, 상업성 광고글이나 건전하지 못한 글은 <br>&nbsp;&nbsp;관련조례에 근거하여 예고없이 삭제됩니다.</p>
            </div>
            ...
            <div class="nttable">	 <!--공지 표-->
				...
				<c:if test="${!empty sid }">
				<div class="btn-group">
				  <a href="${hpath }/qna/qna_ins.jsp" class="notibtn1">글 등록</a>
				</div>
				</c:if>
                </div>
            </div>
